...
export const STATIC_I18N_KEYS = [
  ...
  // Lottery prizes and dynamic draw states
  '100 credits',
  '500 credits',
  'A little extra luck',
  ...
  'The result is being sealed. Please wait.',
  'This draw is complete. Come back tomorrow for another.',
  'You have already drawn today. Come back tomorrow.',
  'The prize pool is not available yet.',
