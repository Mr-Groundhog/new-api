    ...
    build: (settings: AuthSettings) => (
      <BasicAuthSection
        defaultValues={{
          ...
          RegistrationCodeEnabled: settings.RegistrationCodeEnabled,
    ...
    build: (settings: AuthSettings) => (
      <OAuthSection
        ...
        defaultValues={{
          ...
          GithubStarRewardEnabled: settings.GithubStarRewardEnabled,
          GithubStarRewardDryRun: settings.GithubStarRewardDryRun,
          GithubStarOwner: settings.GithubStarOwner,
          GithubStarRepo: settings.GithubStarRepo,
          GithubStarCampaign: settings.GithubStarCampaign,
          GithubStarRewardQuota: settings.GithubStarRewardQuota,
          GithubStarAppId: settings.GithubStarAppId,
          GithubStarInstallationId: settings.GithubStarInstallationId,
          GithubStarPrivateKey: settings.GithubStarPrivateKey,
          GithubStarSyncEnabled: settings.GithubStarSyncEnabled,
