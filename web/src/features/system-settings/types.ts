...
export type SiteSettings = {
  ...
  CooperationMethodsAdmin: string
}
...
export type ContentSettings = {
  ...
  'console_setting.broadcasts': string
  ...
  'console_setting.broadcast_enabled': boolean
...
export type BillingSettings = {
  ...
  'general_setting.redemption_per_user_daily_limit': boolean
...
export type SecuritySettings = {
  ...
  ModelRequestClientRestrictionEnabled: boolean
