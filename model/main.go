...
func migrateDB() error {
	...
	if err := initializeLotteryPrizes(); err != nil {
		return err
	}
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&GithubStarRewardClaim{}, "GithubStarRewardClaim"},
		{&GithubStargazer{}, "GithubStargazer"},
		{&GithubStarAuditLog{}, "GithubStarAuditLog"},
		{&Ticket{}, "Ticket"},
		{&TicketMessage{}, "TicketMessage"},
		{&TokenRiskEvent{}, "TokenRiskEvent"},
		{&CooperationApplication{}, "CooperationApplication"},
		{&CooperationSite{}, "CooperationSite"},
	}
